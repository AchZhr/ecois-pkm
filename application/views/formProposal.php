                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="periode" id="period" value="<?= date('Y') ?>" readonly />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea type="text" class="form-control" rows="10" name="abs" id="abs" placeholder="Abstrak" required /></textarea>
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="dana" id="dana" placeholder="Dana Ajuan" required />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="nidn" id="nidn" placeholder="Nidn Dosen Pembimbing" required />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="npmk" id="npmk" placeholder="Npm Ketua" required />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="npm1" id="npm1" placeholder="Npm Anggota 1" />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="npm2" id="npm2" placeholder="Npm Anggota 2" />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="npm3" id="npm3" placeholder="Npm Anggota 3" />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="npm4" id="npm4" placeholder="Npm Anggota 4" />
                                <span class="input-group-addon">
                                    <span class="fa fa-file"></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="file" name="propo" class="form-control" required>
                                <span class="input-group-addon">
