                                ...
                                foreach ($param as $proposal) { ?>
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            echo anchor(site_url('Admin/verifikasi/' . $proposal->npm), '<i class="fa fa-check fa-lg"></i>&nbsp;&nbsp;Verifikasi', array('title' => 'Detail', 'class' => 'btn btn-sm btn-success'));
