...
<head>
    ...
    <!-- jQuery UI 1.11.4 -->
    <link rel="icon" href="<?php echo base_url(); ?>assets/admin/dist/img/favicon.png" type="image/gif">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/plugins/sweetalert/sweetalert2.min.css">
    <script src="<?php echo base_url() ?>assets/admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/plugins/dropdown/css/dd.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/plugins/magnific/magnific-popup.css">
    <script src="<?php echo base_url() ?>assets/admin/plugins/magnific/jquery.magnific-popup.min.js"></script>
